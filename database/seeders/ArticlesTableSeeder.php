...
Dengan kombinasi inspirasi, pembelajaran mandiri, konsumsi media yang edukatif, dukungan komunitas, serta keteraturan dan disiplin, banyak wibu menunjukkan prestasi akademik yang tinggi.',
            ...
            [
                ...
                'image' => 'https://tse2.mm.bing.net/th?id=OIP.WcqjJwpv_2s42xWkEWr1hAHaE7&pid=Api&P=0&h=220',
                'category_id' => $categories->random()->id,
                'user_id' => $admin->id,
            ],
            [
                ...
                'image' => 'https://tse1.mm.bing.net/th?id=OIP.q2EVSRG97Lnoc4tObapOvQHaHO&pid=Api&P=0&h=220',
                'category_id' => $categories->random()->id,
                'user_id' => $admin->id,
            ],
        ];
